namespace Rydo.Kafka.Client.Configurations.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Registers a type mapping where the created instances will use the given <see cref="ServiceLifetime"/>
        /// </summary>
        /// <param name="serviceType"><see cref="Type"/> that will be requested</param>
        /// <param name="implementationType"><see cref="Type"/> that will actually be returned</param>
        /// <param name="lifetime">The <see cref="ServiceLifetime"/> that controls the lifetime of the returned instance</param>
        /// <returns>The <see cref="IDependencyConfigurator"/> object that this method was called on</returns>
        IDependencyConfigurator Add(Type serviceType, Type implementationType, ServiceLifetime lifetime);
        ...
        /// <returns>The <see cref="IDependencyConfigurator"/> object that this method was called on</returns>
        IDependencyConfigurator Add<TService, TImplementation>(ServiceLifetime lifetime)
        ...
        /// <returns>The <see cref="IDependencyConfigurator"/> object that this method was called on</returns>
        IDependencyConfigurator Add<TService>(ServiceLifetime lifetime)
            where TService : class;
